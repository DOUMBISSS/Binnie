// src/Pages/Auth/LoginApprenant.jsx
      ...
      <div className="adm-root">
        <div className="adm-left">
          ...
          <div className="adm-left-content">
            ...
            <h1 className="adm-headline">
              Apprenez,<br />progressez,<br />
              <span>certifiez‑vous.</span>
            </h1>
            <p className="adm-sub">
              Accédez à vos cours, suivez votre progression et obtenez vos certifications.
            </p>
            <div className="adm-pills">
              {["Cours en ligne", "Suivi personnalisé", "Certifications", "Ressources"].map((m) => (
            ...
            <div className="adm-stats">
              <div className="adm-stat">
                ...
                <div className="adm-stat-l">Apprenants actifs</div>
              </div>
              <div className="adm-stat">
                <div className="adm-stat-n">94%</div>
                <div className="adm-stat-l">Taux de réussite</div>
              </div>
              <div className="adm-stat">
                <div className="adm-stat-n">24/7</div>
                <div className="adm-stat-l">Accès plateforme</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="adm-right">
          <div className="adm-profile-switch">
            <button className="adm-switch-btn active">Apprenant</button>
            <button className="adm-switch-btn" onClick={() => navigate("/login-professeur")}>
              Professeur
            </button>
            <button className="adm-switch-btn" onClick={() => navigate("/login-admin")}>
              Admin
            </button>
          </div>
          ...
          <div className="adm-form-wrap">
            <div className="adm-header">
              ...
              <div className="adm-header-role">Espace Apprenant</div>
            </div>

            <div className="adm-welcome">Bienvenue 👋</div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="adm-footer">
                Pas encore inscrit ? <a href="#">Contactez votre responsable</a>
              </div>
            </form>
          </div>
        </div>
